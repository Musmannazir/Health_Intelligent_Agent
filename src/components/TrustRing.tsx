  ...
  return (
    ...
    >
      <svg width={size} height={size} className="-rotate-90">
        <circle cx={size / 2} cy={size / 2} r={r} fill="none" stroke="oklch(0.88 0.014 230)" strokeWidth={stroke} />
        <circle
          cx={size / 2}
          cy={size / 2}
          r={r}
          ...
          style={{ filter: `drop-shadow(0 0 5px ${color})`, transition: "stroke-dasharray 600ms ease" }}
        />
      </svg>
